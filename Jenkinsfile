node {
    ...
    stage('Deploy Docker Image and login'){
      ...
      echo "Docker Image Tag Name: ${dockerImageTag}"
        ...
        sh "docker images"
        sh "docker login -u amitkabade5 -p amitkabade5" // put PWD
	...
	//sh "read imageid"
	   sh "docker tag 5807d20a3137  amitkabade5/myproject1" //must change your name and tag no
        sh "docker push   amitkabade5/myproject1"
  }
}
